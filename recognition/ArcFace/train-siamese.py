...
def get_symbol(args):
    ...
    is_broad_homogeneity_loss_1 = False
    ...
    if config.loss_name == 'softmax':  #softmax
        ...
        '''SphereFace, ArcFace and CosFace in an united framework with m1, m2 and m3 as the hyper-parameters.'''
        ...
        if config.loss_m1 != 1.0 or config.loss_m2 != 0.0 or config.loss_m3 != 0.0:
            if config.loss_m1 == 1.0 and config.loss_m2 == 0.0:
                ...
                '''SphereFace (m1) and/or ArcFace (m2)'''
    ...
    elif is_broad_homogeneity_loss_1:
        '''apply clustering index to loss (method 1) and pass through CE loss'''
